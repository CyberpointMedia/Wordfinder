...
router.get("/:pageId", wrapAsync(async (req, res) => {
  try {
...
router.get("/view/:pageId", wrapAsync(async (req, res) => {
  try {
    const pageId = req.params.pageId;
...
router.post("/add-section/:pageId", wrapAsync(async (req, res) => {
  try {
    const pageId = req.params.pageId;
...
router.delete("/remove-section/:pageId/:sectionId", wrapAsync(async (req, res) => {
...
router.post("/update-section-order", wrapAsync(async (req, res) => {
  try {
