...
class ThemeCustomizer {
    ...
    initSidenav() {
        ...
        i.forEach(e => {
            e.addEventListener("open.hs.collapse", t => {
                i.forEach(e => {
                    e !== t.target && HSCollapse.hide(e)
                })
            })
        }), setTimeout(function() {
    ...
    initSwitchListener() {
        var i = this,
            ...
            e = (e && e.addEventListener("click", function(e) {
                "light" === i.config.theme ? i.changeThemeMode("dark") : i.changeThemeMode("light")
            }), document.querySelector("#button-toggle-menu1")),
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__SIMPLE_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll("#theme-customization input[type=checkbox]").forEach(function(e) {
            e.checked = !1
        });
